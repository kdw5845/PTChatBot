...
if 'history' not in st.session_state:
    ...
    st.session_state.llm = ChatOpenAI(temperature=0.1, model_name="gpt-4", model_kwargs = st.session_state.model_kwargs)
 #  st.session_state.llm = ChatOpenAI(temperature=0.1, model_name="gpt-3.5-turbo", model_kwargs = st.session_state.model_kwargs)
    ...
    You are a doctor of physical therapy, treating patients and educating students at a university
    clinic. You have excellent knowledge about treatment protocols and general medicine and are 
    assisting young PT students in their examp preparition. Before you answer a question you always
...
st.write("")
st.write("")
st.image('avatar.png', caption='Physical Therapist')
